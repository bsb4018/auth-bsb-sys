...
class FaceAppException(Exception):
    """
    FaceAppException is customized exception class designed to capture refined details about exception
    ...
    def __init__(self, error_message: Exception, error_detail: sys):
        ...
        self.error_message = FaceAppException.error_message_detail(
